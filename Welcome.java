...
//private Account loggedAccount;
    ...
    public Welcome(Customer customer) {
        initComponents();
        this.loggedInCustomer = customer;
        if (customer != null) {
            jLabelWelcome.setText("Welcome, " + customer.getFirstName() + "!");
        }
    ...
    private void initComponents() {
        ...
        jLabelWelcome.setForeground(new java.awt.Color(0, 102, 204));
        jLabelWelcome.setText("Welcome to CTS Bank");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/WhatsApp Image 2025-12-05 at 11.25.48_b0d5cb4c.jpg"))); // NOI18N
        ...
        if (success) {
            JOptionPane.showMessageDialog(this,
                    "Withdrawal successful!\nRemaining Balance: Rs. "
                            + loggedInCustomer.getAccount().getBalance());
        } else {
            JOptionPane.showMessageDialog(this,
    ...
    if (input != null && !input.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(this,
                "Deposit successful!\nNew Balance: Rs. " + loggedInCustomer.getAccount().getBalance());
    }
